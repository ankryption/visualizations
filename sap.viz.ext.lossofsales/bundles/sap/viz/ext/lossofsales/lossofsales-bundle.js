define("lossofsales-bundle", ["sap_viz_ext_lossofsales-src/js/flow", "css!sap_viz_ext_lossofsales-src/style/los_style.css"], function(flowDefinition,cssStyleDeclaration) {
    ...
    var vizExtBundle = sap.bi.framework.declareBundle({
        ...
        "components" : [{
            ...
            "customProperties" : {
                ...
                "icon" : {"path" : ""},
                "category" : [],
                "resources" : [{"key":"sap.viz.api.env.Template.loadPaths", "path":"./sap_viz_ext_lossofsales-src/resources/templates"}]
            }
        }]
   });
